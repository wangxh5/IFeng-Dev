...
public class SendVideoMail {
	private static final String defaultPath = LoadConfig.lookUpValueByKey("defaultPath");

	private static Logger logger = Logger.getLogger(SendVideoMail.class);
	...
	public void process(String endDate) throws IOException {
		...
		sentContent = sentContent + "<p><span style=\"line-height:normal;\"><strong>视频稿源统计表</strong></span></p>";
		sentContent = sentContent + convertTopLocationHtml(defaultPath + endDate + "_videoTopSource.txt");
		sentContent = sentContent + "<p><span style=\"line-height:normal;\"><strong>视频稿源详细统计表</strong></span></p>";
		sentContent = sentContent + convertLocationHtml(defaultPath + endDate + "_videoSource.txt");

		String mail_subject = "MRD移动研发中心|内容入库报表|视频统计表|" + endDate;
		...
		FileWriter fw = new FileWriter(defaultPath + endDate + "_sentVideoSourceContent.txt");
